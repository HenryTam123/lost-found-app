...
const OriginalForm = ({ post = {}, isUpdateMode = false }) => {
  ...
  const [itemOrganisation, setItemOrganisation] = useState("");
  const [isPostingLostItem, setIsPostingLostItem] = useState(true);
  ...
  const renderData = (post = {}) => {
    if (!!post && !!post.contact) {
      ...
      setItemOrganisation(post.organisation || "");
      setIsPostingLostItem(post.isLostItem || true);
  ...
  return (
    <>
      <h4 className="py-2 custom-label mt-3 d-flex justify-content-between">
        {isUpdateMode ? "Update your item" : `List your ${isPostingLostItem ? "lost" : "found"} item on our website `}
      </h4>
          ...
          <Card.Body>
            <Form noValidate validated={validated} onSubmit={isUpdateMode ? handleUpdatePost : handleCreatePost}>
              ...
              <Form.Group id="item_name" className="mb-3">
                <Form.Label>
                  <DriveFileRenameOutlineIcon /> Name of your item{" "}
                  <span className="text-muted">&#40;required&#41;</span>
                </Form.Label>
                <Form.Control
                  type="text"
              ...
              <Form.Group id="item_lost_place" className="mb-3">
                <Form.Label>
                  <LocationOnOutlinedIcon /> Where did you {isPostingLostItem ? "lose" : "find"} the item?{" "}
                  <span className="text-muted">&#40;required&#41;</span>
                </Form.Label>
                <MyMap
              ...
              <Form.Label>
                <DateRangeOutlinedIcon /> When did you {isPostingLostItem ? "lose" : "find"} your item?
              </Form.Label>
              ...
              <Form.Group id="item_organisation" className="mb-3">
                <Form.Label>
                  <ApartmentIcon /> Organisation <span className="text-muted">&#40;optional&#41;</span>
                </Form.Label>
                <Form.Control
                  type="text"
                  placeholder="E.g. ABC Company"
                  value={itemOrganisation}
                  onChange={(e) => setItemOrganisation(e.target.value)}
                ></Form.Control>
              </Form.Group>
